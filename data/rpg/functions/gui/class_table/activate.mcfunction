...
execute as @s[scores={rpg.gui.selected_slot=0..}] run function rpg:gui/shared/check_invalid_item
execute as @s[scores={rpg.gui.selected_slot=0..},tag=!rpg.gui.has_invalid_item] run function rpg:gui/class_table/select
